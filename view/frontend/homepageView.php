...
<?php ob_start(); ?>
<section class="row text-justify justify-content-center m-0 mt-4 custom-background cbg-grey">
    <div class="col-11 text-white">
        <h1 class="my-5 text-center">Bienvenue sur Casse-Brique !</h1>
        ...
        <p class="text-justify mb-5">Rien de plus simple ! Cliquez simplement sur Casse-Brique dans le menu, ou cliquez <a class="cbg-white text-dark" href="idex.php?action=brickBreaker">ici</a>. Ne laissez pas la balle toucher le sol, sinon vous perdez une vie. Plus de vie et c'est perdu ! Le but est, comme le nom du jeu l'indique, casser toutes les briques.</p>
        ...
        <p class="text-justify mb-5">Le score dépend du nombre de briques que vous cassez, du nombre de briques que vous cassez d'affilé sans que la balle ne tombe ou qu'elle ne touche la barre (ce qu'on appelle le combo), du nombre de vie qu'il vous reste à la fin, et de la difficulté (et oui, plus c'est dur, plus cela vous rapporte de points). Vous voulez que vos scores soient sauvegardé ? Il suffit de vous créer un compte. Si vous êtes connecté, votre score sera sauvegardé. Essayez de faire partie des dix meilleurs joueurs et votre pseudo apparaitra dans le <a class="cbg-white text-dark" href="index.php?action=leaderboard">leaderboard</a> !</p>
        <h3 class="">Se créer un compte ? </h3>
        <p class="text-justify mb-5">Là aussi, rien de plus simple. Allez sur la page <a class="cbg-white text-dark" href="index.php?action=login">connexion</a> puis cliquez sur créer un compte. Ou gagnez du temps et allez directement sur la page de <a class="cbg-white text-dark" href="index.php?action=createAccount">création de compte</a>. Déjà inscrit mais vous avez oubliez votre mot de passe ? Pas de panique. Cliquez simplement sur <a class="cbg-white text-dark" href="index.php?action=forgottenPassword">Mot de passe oublié</a> sur la page connexion.</p>
